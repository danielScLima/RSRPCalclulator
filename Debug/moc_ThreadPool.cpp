...
QT_MOC_LITERAL(1, 11, 17), // "broadcastDataSize"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 22) // "brodcastCurrentPogress"

    },
    "ThreadPool\0broadcastDataSize\0\0"
    "brodcastCurrentPogress"
};
...
void ThreadPool::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->broadcastDataSize((*reinterpret_cast< uint(*)>(_a[1]))); break;
        case 1: _t->brodcastCurrentPogress((*reinterpret_cast< uint(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (ThreadPool::*)(unsigned  );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ThreadPool::broadcastDataSize)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (ThreadPool::*)(unsigned  );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ThreadPool::brodcastCurrentPogress)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void ThreadPool::broadcastDataSize(unsigned  _t1)
{
...
// SIGNAL 1
void ThreadPool::brodcastCurrentPogress(unsigned  _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
